...
`~/.claude/skills/pysymbols/pysymbols.py` answers the common structural questions from the Python AST, so a name inside a comment, a docstring, or an unrelated language never produces a false hit.
